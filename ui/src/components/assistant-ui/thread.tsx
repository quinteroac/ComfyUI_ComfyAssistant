...
export const Thread: FC = () => {
  return (
    ...
    >
      ...
      {/* Composer fuera del Viewport: evita que el textarea dispare ResizeObserver/MutationObserver */}
      <div className="aui-composer-outer flex-shrink-0 px-4 pb-4">
        <Composer />
      </div>
    </ThreadPrimitive.Root>
  )
...
const Composer: FC = () => {
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      <ComposerPrimitive.AttachmentDropzone className="aui-composer-attachment-dropzone flex w-full flex-col rounded-2xl border border-border bg-background p-0 outline-none transition-shadow has-[textarea:focus-visible]:border-ring has-[textarea:focus-visible]:ring-2 has-[textarea:focus-visible]:ring-ring/20 data-[dragging=true]:border-ring data-[dragging=true]:border-dashed data-[dragging=true]:bg-accent/50">
        <ComposerAttachments />
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      ...
      data-role="assistant"
    >
      <div className="aui-assistant-message-content break-words px-2 text-foreground leading-relaxed">
        {/* Renderizar texto combinado una sola vez */}
        <MarkdownText />

        {/* Renderizar otras partes (reasoning, tools) usando Parts */}
        <MessagePrimitive.Parts
          components={{
            Text: () => null, // No renderizar texto aquí, ya lo hicimos arriba
            Reasoning: (props) => (
