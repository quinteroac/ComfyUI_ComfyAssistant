...
export const addNodeSchema = z.object({
  ...
  position: z
    ...
    .optional()
    .describe(
      'Optional node position on the canvas. If not specified, adds at default position'
    )
})
...
export const addNodeDefinition = {
  name: 'addNode',
  description:
    'Adds a new node to the ComfyUI workflow. Allows specifying the node type and optionally its position on the canvas.',
