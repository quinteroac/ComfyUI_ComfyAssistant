...
__export(src_exports, {
  ...
  LoadSettingError: () => import_provider21.LoadSettingError,
  ...
  TooManyEmbeddingValuesForCallError: () => import_provider21.TooManyEmbeddingValuesForCallError,
  ...
  dynamicTool: () => import_provider_utils39.dynamicTool,
  embed: () => embed,
  embedMany: () => embedMany,
  ...
  jsonSchema: () => import_provider_utils39.jsonSchema,
  ...
  parseJsonEventStream: () => import_provider_utils39.parseJsonEventStream,
  ...
  tool: () => import_provider_utils39.tool,
...
var _a6;
var MissingToolResultsError = class extends import_provider6.AISDKError {
...
var _a7;
var NoImageGeneratedError = class extends import_provider7.AISDKError {
  constructor({
...
var _a9;
var NoOutputGeneratedError = class extends import_provider9.AISDKError {
  // used in isInstance
  constructor({
...
var _a10;
var NoSpeechGeneratedError = class extends import_provider10.AISDKError {
  constructor(options) {
    super({
      name: name10,
...
var _a11;
var NoTranscriptGeneratedError = class extends import_provider11.AISDKError {
  constructor(options) {
    super({
      name: name11,
  ...
  static isInstance(error) {
    return import_provider11.AISDKError.hasMarker(error, marker11);
  }
};
_a11 = symbol11;
...
var _a12;
var NoVideoGeneratedError = class extends import_provider12.AISDKError {
  constructor({
  ...
  static isInstance(error) {
    return import_provider12.AISDKError.hasMarker(error, marker12);
  }
  /**
...
var NoSuchToolError = class extends import_provider13.AISDKError {
  ...
  static isInstance(error) {
    return import_provider13.AISDKError.hasMarker(error, marker13);
  }
};
_a13 = symbol13;
...
var ToolCallRepairError = class extends import_provider14.AISDKError {
  ...
  static isInstance(error) {
    return import_provider14.AISDKError.hasMarker(error, marker14);
  }
};
_a14 = symbol14;
...
var UnsupportedModelVersionError = class extends import_provider15.AISDKError {
  constructor(options) {
    super({
...
var _a15;
var UIMessageStreamError = class extends import_provider16.AISDKError {
  constructor({
    chunkType,
    chunkId,
    message
...
var _a16;
var InvalidDataContentError = class extends import_provider17.AISDKError {
  constructor({
    content,
    cause,
  ...
  static isInstance(error) {
    return import_provider17.AISDKError.hasMarker(error, marker16);
  }
};
_a16 = symbol16;
...
var _a17;
var InvalidMessageRoleError = class extends import_provider18.AISDKError {
  constructor({
    role,
  ...
  static isInstance(error) {
    return import_provider18.AISDKError.hasMarker(error, marker17);
  }
};
_a17 = symbol17;
...
var _a18;
var MessageConversionError = class extends import_provider19.AISDKError {
  constructor({
    originalMessage,
    message
  }) {
  ...
  static isInstance(error) {
    return import_provider19.AISDKError.hasMarker(error, marker18);
  }
};
_a18 = symbol18;
...
var _a19;
var RetryError = class extends import_provider20.AISDKError {
  constructor({
    message,
    reason,
    errors
  ...
  static isInstance(error) {
    return import_provider20.AISDKError.hasMarker(error, marker19);
  }
};
_a19 = symbol19;
...
function wrapGatewayError(error) {
  ...
  if (isProductionEnv) {
    return new import_provider25.AISDKError({
      name: "GatewayError",
...
var DefaultStreamTextResult = class {
      ...
      async pull(controller) {
        function abort() {
          ...
          controller.enqueue({
            ...
            ...(abortSignal == null ? void 0 : abortSignal.reason) !== void 0 ? { reason: (0, import_provider28.getErrorMessage)(abortSignal.reason) } : {}
          });
          controller.close();
        }
        try {
  ...
  toUIMessageStream({
    ...
    sendStart = true,
    sendFinish = true,
    onError = import_provider28.getErrorMessage
  } = {}) {
        ...
        for (const [partIdx, part] of message.parts.entries()) {
          if (dataSchemas && part.type.startsWith("data-")) {
            ...
            if (!dataSchema) {
              return {
                success: false,
                error: new import_provider29.TypeValidationError({
                  value: dataPart.data,
...
var arrayOutputStrategy = (schema) => {
  return {
    ...
    async validatePartialResult({
      ...
      var _a21;
      if (!(0, import_provider30.isJSONObject)(value) || !(0, import_provider30.isJSONArray)(value.elements)) {
        return {
          success: false,
...
var enumOutputStrategy = (enumValues) => {
  return {
    ...
    async validateFinalResult(value) {
      if (!(0, import_provider30.isJSONObject)(value) || typeof value.result !== "string") {
        return {
          success: false,
          error: new import_provider30.TypeValidationError({
            value,
...
async function parseAndValidateObjectResultWithRepair(result, outputStrategy, repairText, context2) {
  try {
    ...
    if (repairText != null && NoObjectGeneratedError.isInstance(error) && (import_provider31.JSONParseError.isInstance(error.cause) || import_provider31.TypeValidationError.isInstance(error.cause))) {
...
function simulateReadableStream({
  ...
  var _a21;
  const delay2 = (_a21 = _internal == null ? void 0 : _internal.delay) != null ? _a21 : import_provider_utils29.delay;
  let index = 0;
  return new ReadableStream({
    async pull(controller) {
...
function smoothStream({
  ...
  if (chunking != null && typeof chunking === "object" && "segment" in chunking && typeof chunking.segment === "function") {
    ...
    if (chunkingRegex == null) {
      throw new import_provider32.InvalidArgumentError({
        argument: "chunking",
    ...
    if (typeof dataContent === "string") {
      if (dataContent.startsWith("http://") || dataContent.startsWith("https://")) {
        ...
        image = {
          ...
          data: (0, import_provider_utils33.convertBase64ToUint8Array)(base64Content != null ? base64Content : "")
        };
      } else {
        const bytes = (0, import_provider_utils33.convertBase64ToUint8Array)(dataContent);
...
function customProvider({
  ...
  return {
    ...
    languageModel(modelId) {
      ...
      throw new import_provider33.NoSuchModelError({ modelId, modelType: "languageModel" });
    },
    embeddingModel(modelId) {
      ...
      throw new import_provider33.NoSuchModelError({ modelId, modelType: "embeddingModel" });
    },
    imageModel(modelId) {
      ...
      throw new import_provider33.NoSuchModelError({ modelId, modelType: "imageModel" });
    },
    transcriptionModel(modelId) {
      ...
      throw new import_provider33.NoSuchModelError({ modelId, modelType: "transcriptionModel" });
    },
    speechModel(modelId) {
      ...
      throw new import_provider33.NoSuchModelError({ modelId, modelType: "speechModel" });
    },
...
var _a20;
var NoSuchProviderError = class extends import_provider34.NoSuchModelError {
  constructor({
    modelId,
    modelType,
    providerId,
  ...
  static isInstance(error) {
    return import_provider34.AISDKError.hasMarker(error, marker20);
  }
};
_a20 = symbol20;
...
var DefaultProviderRegistry = class {
  ...
  splitId(id, modelType) {
    ...
    if (index === -1) {
      throw new import_provider35.NoSuchModelError({
        modelId: id,
        modelType,
  ...
  languageModel(id) {
    ...
    if (model == null) {
      throw new import_provider35.NoSuchModelError({ modelId: id, modelType: "languageModel" });
    }
  ...
  imageModel(id) {
    ...
    if (model == null) {
      throw new import_provider35.NoSuchModelError({ modelId: id, modelType: "imageModel" });
    }
  ...
  speechModel(id) {
    ...
    if (model == null) {
      throw new import_provider35.NoSuchModelError({ modelId: id, modelType: "speechModel" });
    }
    return model;
  }
  rerankingModel(id) {
    ...
    if (model == null) {
      throw new import_provider35.NoSuchModelError({ modelId: id, modelType: "rerankingModel" });
    }
    return model;
  }
};
...
async function transcribe({
  ...
  const headersWithUserAgent = (0, import_provider_utils34.withUserAgentSuffix)(
    headers != null ? headers : {},
    `ai/${VERSION}`
  );
...
async function callCompletionApi({
  ...
  try {
    ...
    switch (streamProtocol) {
      ...
      case "data": {
        await consumeStream({
          stream: (0, import_provider_utils35.parseJsonEventStream)({
            stream: response.body,
...
var HttpChatTransport = class {
  ...
  async sendMessages({
    ...
    const resolvedBody = await (0, import_provider_utils36.resolve)(this.body);
    const resolvedHeaders = await (0, import_provider_utils36.resolve)(this.headers);
    const resolvedCredentials = await (0, import_provider_utils36.resolve)(this.credentials);
    const baseHeaders = {
      ...(0, import_provider_utils36.normalizeHeaders)(resolvedHeaders),
      ...(0, import_provider_utils36.normalizeHeaders)(options.headers)
    };
    ...
    const headers = (preparedRequest == null ? void 0 : preparedRequest.headers) !== void 0 ? (0, import_provider_utils36.normalizeHeaders)(preparedRequest.headers) : baseHeaders;
...
var DefaultChatTransport = class extends HttpChatTransport {
  ...
  processResponseStream(stream) {
    return (0, import_provider_utils37.parseJsonEventStream)({
      stream,
      schema: uiMessageChunkSchema
    }).pipeThrough(
      new TransformStream({
...
var AbstractChat = class {
  constructor({
    generateId: generateId2 = import_provider_utils38.generateId,
    id = generateId2(),
