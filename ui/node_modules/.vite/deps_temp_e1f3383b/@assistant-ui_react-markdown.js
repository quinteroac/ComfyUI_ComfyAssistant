import {
  ...
  values,
  visit
} from "./chunk-P7RRJLHH.js";
import {
  internal_exports,
  useMessagePartText
} from "./chunk-4AE6EZKI.js";
import "./chunk-3BGZJQKZ.js";
import {
  useCallbackRef
} from "./chunk-YDLZUPUI.js";
import "./chunk-H4KYLSX2.js";
import "./chunk-XJ36GILZ.js";
import {
  require_jsx_runtime
...
// node_modules/@assistant-ui/react-markdown/dist/primitives/MarkdownText.js
...
// node_modules/@assistant-ui/react-markdown/dist/overrides/PreOverride.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var import_react3 = __toESM(require_react(), 1);

// node_modules/@assistant-ui/react-markdown/dist/memoization.js
...
var areNodesEqual = (prev, next) => {
  ...
  const excludeMetadata = (props) => {
    const { position: position3, data, ...rest } = props || {};
    return rest;
  };
...
var memoizeMarkdownComponents = (components = {}) => {
  return Object.fromEntries(Object.entries(components ?? {}).map(([key, value]) => {
    ...
    const WithoutNode = ({ node, ...props }) => {
      return (0, import_jsx_runtime2.jsx)(Component, { ...props });
    };
    return [key, (0, import_react2.memo)(WithoutNode, memoCompareNodes)];
  }));
};

// node_modules/@assistant-ui/react-markdown/dist/overrides/PreOverride.js
var PreContext = (0, import_react3.createContext)(null);
var useIsMarkdownCodeBlock = () => {
  return (0, import_react3.useContext)(PreContext) !== null;
};
var PreOverrideImpl = ({ children, ...rest }) => {
  return (0, import_jsx_runtime3.jsx)(PreContext.Provider, { value: rest, children });
};
var PreOverride = (0, import_react3.memo)(PreOverrideImpl, memoCompareNodes);

// node_modules/@assistant-ui/react-markdown/dist/overrides/defaultComponents.js
var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
var DefaultPre = ({ node, ...rest }) => (0, import_jsx_runtime4.jsx)("pre", { ...rest });
var DefaultCode = ({ node, ...rest }) => (0, import_jsx_runtime4.jsx)("code", { ...rest });
var DefaultCodeBlockContent = ({ node, components: { Pre, Code }, code: code2 }) => (0, import_jsx_runtime4.jsx)(Pre, { children: (0, import_jsx_runtime4.jsx)(Code, { node, children: code2 }) });
var DefaultCodeHeader = () => null;

// node_modules/@assistant-ui/react-markdown/dist/overrides/CodeOverride.js
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var import_react5 = __toESM(require_react(), 1);

// node_modules/@assistant-ui/react-markdown/dist/overrides/CodeBlock.js
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var import_react4 = __toESM(require_react(), 1);
var DefaultCodeBlock = ({ node, components: { Pre, Code, SyntaxHighlighter, CodeHeader }, language, code: code2 }) => {
  const components = (0, import_react4.useMemo)(() => ({ Pre, Code }), [Pre, Code]);
  const SH = language ? SyntaxHighlighter : DefaultCodeBlockContent;
  return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)(CodeHeader, { node, language, code: code2 }), (0, import_jsx_runtime5.jsx)(SH, { node, components, language: language ?? "unknown", code: code2 })] });
};

// node_modules/@assistant-ui/react-markdown/dist/overrides/withDefaults.js
...
// node_modules/@assistant-ui/react-markdown/dist/overrides/CodeOverride.js
var CodeBlockOverride = ({ node, components: { Pre, Code, SyntaxHighlighter: FallbackSyntaxHighlighter, CodeHeader: FallbackCodeHeader }, componentsByLanguage = {}, children, ...codeProps }) => {
  var _a, _b, _c;
  const preProps = (0, import_react5.useContext)(PreContext);
  const getPreProps = withDefaultProps(preProps);
  const WrappedPre = useCallbackRef((props) => (0, import_jsx_runtime6.jsx)(Pre, { ...getPreProps(props) }));
  const getCodeProps = withDefaultProps(codeProps);
  const WrappedCode = useCallbackRef((props) => (0, import_jsx_runtime6.jsx)(Code, { ...getCodeProps(props) }));
  const language = ((_a = /language-(\w+)/.exec(codeProps.className || "")) == null ? void 0 : _a[1]) ?? "";
  if (typeof children !== "string") {
    return (0, import_jsx_runtime6.jsx)(DefaultCodeBlockContent, { node, components: { Pre: WrappedPre, Code: WrappedCode }, code: children });
  }
  const SyntaxHighlighter = ((_b = componentsByLanguage[language]) == null ? void 0 : _b.SyntaxHighlighter) ?? FallbackSyntaxHighlighter;
  const CodeHeader = ((_c = componentsByLanguage[language]) == null ? void 0 : _c.CodeHeader) ?? FallbackCodeHeader;
  return (0, import_jsx_runtime6.jsx)(DefaultCodeBlock, { node, components: {
    Pre: WrappedPre,
    Code: WrappedCode,
    SyntaxHighlighter,
    CodeHeader
...
var CodeOverrideImpl = ({ node, components, componentsByLanguage, ...props }) => {
  const isCodeBlock = useIsMarkdownCodeBlock();
  if (!isCodeBlock)
    return (0, import_jsx_runtime6.jsx)(components.Code, { ...props });
  return (0, import_jsx_runtime6.jsx)(CodeBlockOverride, { node, components, componentsByLanguage, ...props });
};
var CodeOverride = (0, import_react5.memo)(CodeOverrideImpl, (prev, next) => {
...
var { useSmooth, useSmoothStatus, withSmoothContextProvider } = internal_exports;
var MarkdownTextInner = ({ components: userComponents, componentsByLanguage, smooth = true, preprocess: preprocess2, ...rest }) => {
  const messagePartText = useMessagePartText();
  const processedMessagePart = (0, import_react7.useMemo)(() => {
    if (!preprocess2)
      return messagePartText;
    return {
      ...messagePartText,
      text: preprocess2(messagePartText.text)
    };
  }, [messagePartText, preprocess2]);
  const { text: text5 } = useSmooth(processedMessagePart, smooth);
  const { pre = DefaultPre, code: code2 = DefaultCode, SyntaxHighlighter = DefaultCodeBlockContent, CodeHeader = DefaultCodeHeader } = userComponents ?? {};
  const useCodeOverrideComponents = (0, import_react7.useMemo)(() => {
    return {
      Pre: pre,
      Code: code2,
      SyntaxHighlighter,
  ...
  }, [pre, code2, SyntaxHighlighter, CodeHeader]);
  const CodeComponent = useCallbackRef((props) => (0, import_jsx_runtime7.jsx)(CodeOverride, { components: useCodeOverrideComponents, componentsByLanguage, ...props }));
  const components = (0, import_react7.useMemo)(() => {
    const { pre: pre2, code: code3, SyntaxHighlighter: SyntaxHighlighter2, CodeHeader: CodeHeader2, ...componentsRest } = userComponents ?? {};
    return {
      ...componentsRest,
      pre: PreOverride,
      code: CodeComponent
  ...
  return (0, import_jsx_runtime7.jsx)(Markdown, { components, ...rest, children: text5 });
};
var MarkdownTextPrimitiveImpl = (0, import_react7.forwardRef)(({ className, containerProps, containerComponent: Container = "div", ...rest }, forwardedRef) => {
  const status = useSmoothStatus();
  return (0, import_jsx_runtime7.jsx)(Container, { "data-status": status.type, ...containerProps, className: (0, import_classnames2.default)(className, containerProps == null ? void 0 : containerProps.className), ref: forwardedRef, children: (0, import_jsx_runtime7.jsx)(MarkdownTextInner, { ...rest }) });
});
MarkdownTextPrimitiveImpl.displayName = "MarkdownTextPrimitive";
var MarkdownTextPrimitive = withSmoothContextProvider(MarkdownTextPrimitiveImpl);
export {
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=@assistant-ui_react-markdown.js.map
