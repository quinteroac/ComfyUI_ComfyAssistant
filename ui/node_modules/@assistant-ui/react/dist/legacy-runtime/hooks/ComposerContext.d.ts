...
export declare const useComposer: {
    (): import("../runtime").ComposerState;
    <TSelected>(selector: (state: import("../runtime").ComposerState) => TSelected): TSelected;
    <TSelected>(selector: ((state: import("../runtime").ComposerState) => TSelected) | undefined): import("../runtime").ComposerState | TSelected;
    (options: {
        optional?: false | undefined;
    }): import("../runtime").ComposerState;
    (options: {
        optional?: boolean | undefined;
    }): import("../runtime").ComposerState | null;
    <TSelected>(options: {
        optional?: false | undefined;
        selector: (state: import("../runtime").ComposerState) => TSelected;
    }): TSelected;
    <TSelected>(options: {
        optional?: false | undefined;
        selector: ((state: import("../runtime").ComposerState) => TSelected) | undefined;
    }): import("../runtime").ComposerState | TSelected;
    <TSelected>(options: {
        optional?: boolean | undefined;
        selector: (state: import("../runtime").ComposerState) => TSelected;
    }): TSelected | null;
    <TSelected>(options: {
        optional?: boolean | undefined;
        selector: ((state: import("../runtime").ComposerState) => TSelected) | undefined;
    }): import("../runtime").ComposerState | TSelected | null;
};
