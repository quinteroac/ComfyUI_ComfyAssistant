...
export declare const useAttachment: {
    ...
    <TSelected>(selector: (state: import("../runtime").AttachmentState & {
        source: "message" | "edit-composer" | "thread-composer";
    }) => TSelected): TSelected;
    <TSelected>(selector: ((state: import("../runtime").AttachmentState & {
        source: "message" | "edit-composer" | "thread-composer";
    }) => TSelected) | undefined): (import("../runtime").AttachmentState & {
        source: "message" | "edit-composer" | "thread-composer";
    }) | TSelected;
    (options: {
        optional?: false | undefined;
    ...
    <TSelected>(options: {
        optional?: false | undefined;
        selector: (state: import("../runtime").AttachmentState & {
            source: "message" | "edit-composer" | "thread-composer";
        }) => TSelected;
    }): TSelected;
    <TSelected>(options: {
