import type { AddToolResultOptions, ResumeRunConfig, ResumeToolCallOptions, StartRunConfig, ThreadSuggestion } from "../core/ThreadRuntimeCore.js";
import type { AppendMessage, ThreadMessage } from "../../../types/index.js";
import type { ExternalStoreAdapter } from "./ExternalStoreAdapter.js";
import { type ThreadMessageLike } from "./ThreadMessageLike.js";
import type { RuntimeCapabilities, ThreadRuntimeCore } from "../core/ThreadRuntimeCore.js";
import { BaseThreadRuntimeCore } from "../core/BaseThreadRuntimeCore.js";
import type { ModelContextProvider } from "../../../model-context/index.js";
...
export declare class ExternalStoreThreadRuntimeCore extends BaseThreadRuntimeCore implements ThreadRuntimeCore {
    ...
    get adapters(): {
        ...
        dictation?: import("..").DictationAdapter | undefined;
